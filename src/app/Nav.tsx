...
function Nav() {
  return (
    <nav className=" navbar bbg-transparent sticky left-0 top-0 z-[9999] flex h-fit w-full flex-row justify-center bg-opacity-60 text-text-main backdrop-blur-md">
